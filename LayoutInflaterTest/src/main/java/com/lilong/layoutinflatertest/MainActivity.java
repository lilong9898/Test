...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * 结果：会无视vg_test1.xml中的顶层的尺寸
         * 由vg_test1.xml将要被加入的parentView(即LinearLayout container)来调用{@link LinearLayout#generateDefaultLayoutParams()}生成默认layoutParams
         * */
        ...
        /**
         * 结论：inflate方法的三个参数
         * (1)root是null的话，得到的view是xml的顶层view，且无layoutParams，在addView时才会被上级布局加上{@link ViewGroup#generateDefaultLayoutParams()}生成的默认layoutParams
         * (2)root非null，attachToRoot=false，得到的view是xml的顶层view，有layoutParams，就是根据顶层view的attr解析出的layoutParams
         * (3)root非null，attachToRoot=true，得到的view是root，这个root无layoutParams，在addView时才会被上级布局加默认layoutParams
